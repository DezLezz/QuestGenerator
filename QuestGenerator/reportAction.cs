    ...
    public class reportAction : actionTarget
    {
        ...
        public override void QuestQ(QuestBase questBase, QuestGenTestQuest questGen)
        {
            if (this.heroTarget != null)
            {
                ...
                Campaign.Current.ConversationManager.AddDialogFlow(this.GetReportActionDialogFlow(this.heroTarget, this.index, questBase.QuestGiver, questBase, questGen), this);
            }
        }
